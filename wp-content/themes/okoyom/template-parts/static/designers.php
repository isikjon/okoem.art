    ...
    <div class="container">
        ...
        <div class="blockSectionDesignersTopPluses">
            <div data-aos="fade" data-aos-offset="200" class="blockSectionDesignersTopPluses__block">
                ...
                <div class="flex-blockSectionDesignersTopPluses__block">
                    <div class="row-flex-blockSectionDesignersTopPluses__block">
                        <div class="line-flex-blockSectionDesignersTopPluses__block">
            ...
            <div data-aos="fade" data-aos-offset="200" class="blockSectionDesignersTopPluses__block blockSectionDesignersTopPluses__blockActive">
                ...
                <div class="flex-blockSectionDesignersTopPluses__block">
                    <div class="row-flex-blockSectionDesignersTopPluses__block">
                        <div style="background: rgba(242, 240, 237, 0.30);" class="line-flex-blockSectionDesignersTopPluses__block">
...
<section class="sectionMain sectionMainV2">
    <div class="container">
        ...
        <div class="flexInfoSectionDesigners">
...
<!--<section class="sectionMain">-->
<!--    <div class="container">-->
<!--        <div class="favWorks__top">-->
<!--            <div class="titleSection titleSectionMaxWidth">-->
<!--                <span class="titleSectionSpan">-->
<!--                   Для бизнеса-->
<!--                </span>-->
<!--                <h2 class="titleSectionTitle">-->
<!--                    Когда проекту нужно что-то свежее-->
<!--                </h2>-->
<!--                <p class="textTitleSection">-->
<!--                    Муралы Окоём подходят для проектов, где обычная акцентная стена уже не решает-->
<!--                    задачу. Они дают интерьеру глубину, настроение и узнаваемость — особенно в-->
<!--                    спальнях, гостиных, холлах, ресторанах, отелях и общественных пространствах.-->
<!--                </p>-->
<!--            </div>-->
<!--            <div class="favWorks__nav">-->
<!--                <div class="favWorks__pagination"></div>-->

<!--                <button class="favWorks__btn favWorks__btn&#45;&#45;prev">-->
<!--                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">-->
<!--                        <path d="M15 6L9 12L15 18" stroke="currentColor" stroke-width="1.5"/>-->
<!--                    </svg>-->
<!--                </button>-->

<!--                <button class="favWorks__btn favWorks__btn&#45;&#45;next">-->
<!--                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">-->
...
<!--            </div>-->
<!--        </div>-->
<!--        <div class="swiper favWorksSlider">-->
...
<!--            <h3 class="top-textWorkSlider">-->
<!--                Работаем с отелями, ресторанами, спа-салонами и-->
<!--                общественными пространствами.-->
<!--            </h3>-->
<!--            <div class="flex-textWorkSlider">-->
<!--                <div class="block-flex-textWorkSlider">-->
<!--                    <p>-->
<!--                        Материалы для высоких нагрузок-->
<!--                    </p>-->
<!--                    <span>-->
<!--                        Винил на флизелине класса А. Антивандальное покрытие, устойчивость к UV и влаге.-->
<!--                    </span>-->
<!--                </div>-->
<!--                <div class="block-flex-textWorkSlider">-->
<!--                    <p>-->
...
<!--                    </p>-->
<!--                    <span>-->
<!--                        Полотна до 6 метров без швов. Многометровые панорамы для лобби отелей.-->
<!--                    </span>-->
<!--                </div>-->
<!--                <div class="block-flex-textWorkSlider">-->
<!--                    <p>-->
...
<!--                    </p>-->
<!--                    <span>-->
<!--                        Корректируем палитру под брендбук заведения.-->
<!--                    </span>-->
<!--                </div>-->
<!--                <div class="block-flex-textWorkSlider">-->
<!--                    <p>-->
...
<!--                    </p>-->
<!--                    <span>-->
<!--                        Профессиональный монтаж в Москве и Петербурге. Гарантия — 2 года.-->
<!--                    </span>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
