			...
			array(
				...
				'fields'   => array(
					array(
						...
						'type'         => 'repeater',
						'instructions' => 'Кружки «Цветовое решение» на карточке. Первая версия — по умолчанию. Укажите карточку, чтобы клик вёл на другой товар.',
						'layout'       => 'table',
						...
						'sub_fields'   => array(
							...
							array(
								'key'           => 'field_okoyom_color_product',
								'label'         => 'Карточка',
								'name'          => 'product',
								'type'          => 'post_object',
								'instructions'  => 'Товар, на который ведёт клик по кружку. Если не выбран — просто меняется изображение.',
