...
<section class="inspirationTop mural-hero--intro">
    <div class="container">
        <div class="flexTopContact">
            ...
            <span class="titleSectionSpan mural-hero__fade-up">
               <?php echo okoyom_t( '75768c49c246', 'Контакты' ); ?>
                ...
                <div class="links-left-flexTopContact">
                    ...
                    <a href="mailto:hello@calme.studio" class="links-left-flexTopContact__a">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
            ...
            <div class="right-flexTopContact">
                ...
                <div class="socials-right-flexTopContact">
...
<section class="sectionMain">
    <div class="map">
        <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Ad03e8d5568729d69d2cf663f156d605984da11c2f8893f41e15072e4eec1e368&amp;width=100%25&amp;height=100%&amp;lang=ru_RU&amp;scroll=true"></script>
    </div>
</section>
<section class="sectionMain">
    <div class="container">
