        ...
        <div class="flex-cardSectionContent">
            ...
            <div class="right-flex-cardSectionContent">
                <div class="title-right-flex-cardSectionContent">
                    ...
                    <p>
                        Панорама горных хребтов в духе пейзажной живописи начала XX века. Многослойные планы создают ощущение глубины и тихого величия.
                    </p>
                </div>
            ...
            <div class="photo-left-flexCardLastInfoBlock">
                ...
                <div class="contentText-photo-left-flexCardLastInfoBlock">
                    <p class="text-contentText-photo-left-flexCardLastInfoBlock">
                        Изготовим однотонные фоновые обои для соседних стен — в любом цвете из палитры «Дальние хребты» и на том же материале, что и сам мурал.
                    </p>
                    <div class="flex-contentText-photo-left-flexCardLastInfoBlock">
                        <div class="block-flex-contentText-photo-left-flexCardLastInfoBlock">
                            ...
                            <div class="text-block-flex-contentText-photo-left-flexCardLastInfoBlock">
                                <p>
                                    Любой цвет из мурала
                                </p>
                                <span>
                                    Подберём оттенок точно по образцу художественного полотна.
                                </span>
                            </div>
                        </div>
                        <div class="block-flex-contentText-photo-left-flexCardLastInfoBlock">
                            ...
                            <div class="text-block-flex-contentText-photo-left-flexCardLastInfoBlock">
                                ...
                                <span>
                                    Единая фактура и качество печати по всей композиции.
                                </span>
                            </div>
                        </div>
                        <div class="block-flex-contentText-photo-left-flexCardLastInfoBlock">
                            ...
                            <div class="text-block-flex-contentText-photo-left-flexCardLastInfoBlock">
                                <p>
                                    Печать по размеру стены
                                </p>
                                <span>
                                    Бесшовное полотно под точные параметры помещения.
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="flexPlusesMainCards">
            <div data-aos="fade-left" data-aos-offset="200" class="block-flexPlusesMainCards">
                ...
                <p>
                    Выбираете изображение из коллекции или описываете задачу — поможем определиться с серией и форматом.
                </p>
            </div>
            <div data-aos="fade-left" data-aos-offset="200" class="block-flexPlusesMainCards">
                <span>
                ...
                <p>
                    Присылаете размеры и фото интерьера — готовим бесплатную визуализацию, прежде чем принимать решение.
                </p>
            </div>
            <div data-aos="fade-left" data-aos-offset="200" class="block-flexPlusesMainCards">
                <span>
